# Image: i3drobotics/rtabmap:bionic_gitpod

FROM ros:melodic-perception

# Install build dependencies
RUN sudo apt-get update && \
    sudo apt-get install -y git software-properties-common ros-melodic-rtabmap-ros && \
    sudo apt-get remove -y ros-melodic-rtabmap && \
